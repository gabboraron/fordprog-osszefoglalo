...
elagazas:
    ...
    {
        std::cout << "elagazas -> ha_ag kulonbenha_agak kulonben_ag" << std::endl;
    }
;
...
ha_ag:
    ...
    {
        std::cout << "ha_ag -> HA kifejezes AKKOR utasitasok" << std::endl;
    }
;
...
kulonbenha_agak:
    // ures
    {
        std::cout << "kulonbenha_agak -> epsilon" << std::endl;
    }
|
    kulonbenha_agak KULONBENHA kifejezes AKKOR utasitasok
    {
        std::cout << "kulonbenha_agak -> kulonbenha_agak KULONBENHA kifejezes AKKOR utasitasok" << std::endl;
    }
;
...
kulonben_ag:
    // ures
    {
        std::cout << "kulonben_ag -> epsilon" << std::endl;
    }
|
    KULONBEN utasitasok
    {
        std::cout << "kulonben_ag -> KULONBEN utasitasok" << std::endl;
    }
;
